...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE reserva SET cliente_cpf = '$cliente_cpf', cliente_email = '$cliente_email', data = '$data', horario = '$horario', num_pessoas = '$num_pessoas', motivo = '$motivo' WHERE id = $id";
                            ...
                            <form action="reserva_atualiza.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data" name="form_atualiza_reserva" id="form_atualiza_reserva">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        type="text"
                                        name="email"
                                        value="<?php echo isset($row['cliente_email']) ? $row['cliente_email'] : ''; ?>"
                                        id="email"
                                        maxlength="300"
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        type="date"
                                        name="data"
                                        value="<?php echo isset($row['data']) ? $row['data'] : ''; ?>"
                                        id="data"
                                        class="form-control"
                                        required
                                        autocomplete="off">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        type="time"
                                        name="horario"
                                        value="<?php echo isset($row['horario']) ? $row['horario'] : ''; ?>"
                                        id="horario"
                                        class="form-control"
                                        required
                                        autocomplete="off">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        type="number"
                                        name="num_pessoas"
                                        value="<?php echo isset($row['num_pessoas']) ? $row['num_pessoas'] : '1'; ?>"
                                        id="num_pessoas"
                                        min="1"
                                        max="99"
                                        class="form-control"
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea
                                        name="motivo"
                                        id="motivo"
                                        placeholder='Digite seu motivo (Ex: "Casamento", "Aniversário", etc.)'
                                        class="form-control"
                                        required
                                        autocomplete="off"><?php echo isset($row['motivo']) ? $row['motivo'] : ''; ?></textarea>
                                </div>
                                <br>
                                <!-- Campo ativo oculto (1 = ativo) -->
